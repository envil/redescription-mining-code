...
meaningful results at \goal{anytime}.  In other words, if the
...
to instructions from the users. Low latency or even \goal{instantaneity} is a core
...
\note{We might need an illustration for that one...?}
