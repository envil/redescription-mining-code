...
\note{That part comes pretty close to interactivity, it's about automating interactions attaching a meaning to sequences of interactions, allowing segmented interactivity (like, different users interacting with the tool in turn)}
