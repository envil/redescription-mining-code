...
class Constraints:
    ...
    def __init__(self, N=None, setts=None):
        self.N = N
        self._amnesic = False
        self._batch_out = 1
        self._batch_cap = 4
        ...
        self._score_coeffs = {"impacc": 1, "rel_impacc": 0, "pVal_red": 0.01, "pVal_query": 0.01, "pVal_fact": 1 }
        self._method_pVal = "marg"
        SParts.setMethodPVal(self._method_pVal)
    ...
    def scaleSuppParams(self, min_c, min_in=None, min_out=None):
        ...
        return (sc_min_c, sc_min_in, sc_in_out)
