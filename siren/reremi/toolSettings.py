...
class Settings:
    ...
    setts_help = {'log': {'verbosity' : '    INT level of verbosity, 0: silent, 10:verbose',
                  ...
                  'mine': { 'nb_variables': ' >< INT number of variables per query',
                            ...
                            'batch_capacity': '    INT batch capacity, number of different redescriptions retained at each step',
                            'batch_output': '    INT batch output, number of different redescriptions finally output from the batch',
                            'min_improvement': '    FLOAT minimum score improvement over parent redescription for an extension to be added to the batch',
    ...
    default_setts['mine']= {'verbosity': 1, 'logfile': '-',
                              ...
                              'batch_capacity': 4, 'batch_output': 1, 'min_improvement': 0.0,
