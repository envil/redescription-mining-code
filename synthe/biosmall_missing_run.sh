...
RESULTS_REP=${BASE_REP}results_nop/
DATA_L=mammals
EXT_L=.datbool
DATA_R=worldclim_tp
EXT_R=.densenum
...
COMP_QUERIES=${BASE_REP}results/small${EXT_RULES}
MINE_CONF=~/redescriptors/sandbox/synthe/biosmall_missing_nop_template.conf
...
OTHER_VAR_PARAMS='::DATA_REP::='$DATA_REP',::DATA_R::='$DATA_R',::DATA_L::='$DATA_L',::RESULTS_REP::='$RESULTS_REP',::EXT_RULES::='$EXT_RULES',::EXT_L::='$EXT_L',::EXT_R::='$EXT_R',::SUFF_DATA::='$SUFF_MISS',::SUFF_MISS::='$SUFF_MISS
...
OTHER_VAR_PARAMS_COMP='::DATA_REP::='$DATA_REP',::DATA_R::='$DATA_R',::DATA_L::='$DATA_L',::RESULTS_REP::='$RESULTS_REP',::EXT_RULES::='$EXT_RULES',::EXT_L::='$EXT_L',::EXT_R::='$EXT_R',::SUFF_DATA::='$SUFF_MISS',::SUFF_MISS::='$SUFF_MISS
...
#    TYPE='1pc1'
    TYPE_QUERYORG=$TYPE"queryorg"

    cp $COMP_QUERIES ${RESULTS_REP}${TYPE_QUERYORG}_${SUFF_MISS}${EXT_RULES}
    OUT=${RESULTS_REP}${TYPE}_${SUFF_MISS}
    echo "Mining ${TYPE} ..." 1>&2
    /usr/bin/time -f "$TIME_FORMAT" -o ${OUT}$EXT_TIME  $MINE_SCRIPT $MINE_CONF '::TYPE::='$TYPE',''::TYPE_COMP::='$TYPE','$OTHER_VAR_PARAMS	
    $POST_SCRIPT $MINE_CONF '::TYPE::=,::TYPE_COMP::='$TYPE','$OTHER_VAR_PARAMS_POST	
    ...
    $POST_SCRIPT $MINE_CONF '::TYPE::='$TYPE',::TYPE_COMP::='$TYPE_QUERYORG','$OTHER_VAR_PARAMS_COMP	
    rm ${RESULTS_REP}${TYPE_QUERYORG}_${SUFF_MISS}${EXT_RULES}
done
