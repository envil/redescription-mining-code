...
PACK_REP=${YAH}/packaging_pip-reremi_$(date "+%Y%m%d%H%M%S")
ROOT_REP=${PACK_REP}/python-reremi/

# ### checkout the code itself
mkdir -p ${ROOT_REP}
cp -r ${SRC_REP}/siren/reremi ${ROOT_REP}
...
cp ${ADD_REP}/setup_reremi.py ${ROOT_REP}/setup.py
cp ${ADD_REP}/prepare_pck_reremi.py ${ROOT_REP}/
python ${ROOT_REP}/prepare_pck_reremi.py src
rm ${ROOT_REP}/prepare_pck_reremi.py
