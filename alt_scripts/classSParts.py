...
# ##############################################################
#     ##### TO COMPUTE ADVANCE while building, INDEXED BY OPERATOR (0: AND, 1: OR)
#     # IDS_fixnum = [[],[(tot, mua), (tot, gamma), (tot, mud), (tot, mub), (miss, muaB), (miss, beta)]]
#     # IDS_varnum = [[(into, mua), (miss,mua), (into, gamma), (miss, gamma), (into, mub), (miss, mub), (into, mud), (miss, mud)],[(into, muaB), (into, beta)]]
#     # IDS_fixden = [[(tot, gamma), (tot, mub), (tot, beta)],[(tot, mua), (tot, gamma), (tot, mub), (tot, mud), (miss, muaB), (tot, beta), (tot, alpha)]]
#     # IDS_varden = [[(into, alpha), (into, mua), (miss, mua), (into, mud), (miss, mud)],[(into, delta), (into, mubB), (into, muaB)]]
