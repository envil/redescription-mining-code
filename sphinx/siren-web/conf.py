...
html_title = "Siren - Interactive and visual redescription mining"
...
html_sidebars = {
    ...
    'index': ['searchbox_web_toguide.html'] #, 'sourcelink.html'],
...
latex_documents = [
  ('index', 'Siren.tex', u'Siren Documentation',
   u'Esther Galbrun and Pauli Miettinen', 'manual'),
]
