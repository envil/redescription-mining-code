...
extlinks = {'project_url': (cv["PROJECT_URL"]+"%s", cv["PROJECT_NAME"]),
            ...
            'src_release': (cv["CODE_URL"]+cv["PACKAGE_NAME"]+"-"+release+"%s",
...
html_title = cv["PROJECT_NAME"] +"- Mining predictive Redescriptions with Trees - Demo at ICDM 2015"
...
latex_documents = [
  ('index', 'Siren.tex', u''+cv["PROJECT_NAME"]+' Demo at ICDM 2015',
...
man_pages = [
    ('index', cv["PROJECT_NAME"], u''+cv["PROJECT_NAME"]+' Demo at ICDM 2015',
